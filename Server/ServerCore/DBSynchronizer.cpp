...
{
	ParseXmlDB(path);//_xmlTables,_xmlProcedures업데이트

	GatherDBTables();//_dbTables
	GatherDBIndexes();//
	GatherDBStoredProcedures();//_dbProcedures

	CompareDBModel();//xml,db비교
	ExecuteUpdateQueries();//_updateQueries

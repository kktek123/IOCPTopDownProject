///////////////////////////////////////////////////////////////////////////////
//                                                                           //
//                  LibXL Delphi/Lazarus unit version 4.6.0                  //
//                                                                           //
...
function xlSheetSetBorder(handle: SheetHandle; rowFirst: Integer; rowLast: Integer; colFirst: Integer; colLast: Integer; borderStyle: Integer; borderColor: Integer): Integer cdecl;
...
function xlTableSetColumnName(handle: TableHandle; columnIndex: Integer; name: PWideChar):boolean cdecl;
...
type
  ...
  published
    constructor Create(formControlHandle: FormControlHandle; bookHandle: BookHandle);
  end;
...
type
  ...
  public
    ...
    constructor Create(filterColumnHandle: FilterColumnHandle; bookHandle: BookHandle);
...
type
  ...
  public
    ...
    constructor Create(autoFilterHandle: AutoFilterHandle; bookHandle: BookHandle);
    destructor Destroy; override;
  end;
...
type
  ...
  public
    ...
    constructor Create(fontHandle: FontHandle; bookHandle: BookHandle);
    destructor Destroy; override;
  end;
...
type
  ...
  public
    ...
    constructor Create(richStringHandle: RichStringHandle; bookHandle: BookHandle);
    destructor Destroy; override;
  end;
...
type
  ...
  public
    ...
    constructor Create(formatHandle: FormatHandle; bookHandle: BookHandle);
    destructor Destroy; override;
  end;
...
type
  ...
  public
     ...
     constructor Create(conditionalFormatHandle: ConditionalFormatHandle; bookHandle: BookHandle);
     destructor Destroy; override;
  end;
...
type
  ...
  published
    constructor Create(conditionalFormattingHandle: ConditionalFormattingHandle; bookHandle: BookHandle);
  end;
...
type
  ...
  published
    constructor Create(corePropertiesHandle: CorePropertiesHandle; bookHandle: BookHandle);
  end;
...
type
  ...
  public
    ...
    function setColumnName(columnIndex: Integer; const _name: PWideChar): boolean;

    published
      constructor Create(tableHandle: TableHandle; bookHandle: BookHandle);
  end;
...
type
  ...
  public
    ...
    constructor Create(sheetHandle: SheetHandle; bookHandle: BookHandle);
    destructor Destroy; override;
  end;
...
constructor TXLConditionalFormatting.Create(conditionalFormattingHandle: ConditionalFormattingHandle; bookHandle: BookHandle);
begin
  inherited Create;
  self.book := bookHandle;
  self.handle := conditionalFormattingHandle;
end;

//////////////////////////////////////////////////

constructor TXLFormControl.Create(formControlHandle: FormControlHandle; bookHandle: BookHandle);
begin
  inherited Create;
  self.book := bookHandle;
  self.handle := formControlHandle;
end;
...
constructor TXLCoreProperties.Create(corePropertiesHandle: CorePropertiesHandle; bookHandle: BookHandle);
begin
  inherited Create;
  self.book := bookHandle;
  self.handle := corePropertiesHandle;
end;
...
function TXLTable.setColumnName(columnIndex: Integer; const _name: PWideChar): boolean;
begin
  result := xlTableSetColumnName(handle, columnIndex, PWideChar(_name));
end;

constructor TXLTable.Create(tableHandle: TableHandle; bookHandle: BookHandle);
begin
  inherited Create;
  self.book := bookHandle;
...
constructor TXLRichString.Create(richStringHandle: RichStringHandle; bookHandle: BookHandle);
begin
  inherited Create;
  self.book := bookHandle;
  self.handle := richStringHandle;
end;
...
constructor TXLFilterColumn.Create(filterColumnHandle: FilterColumnHandle; bookHandle: BookHandle);
begin
  inherited Create;
  self.book := bookHandle;
  self.handle := filterColumnHandle;
end;
...
constructor TXLAutoFilter.Create(autoFilterHandle: AutoFilterHandle; bookHandle: BookHandle);
begin
  inherited Create;
  self.book := bookHandle;
  self.handle := autoFilterHandle;
end;
...
constructor TXLFont.Create(fontHandle: FontHandle; bookHandle: BookHandle);
begin
  inherited Create;
  self.book := bookHandle;
...
constructor TXLFormat.Create(formatHandle: FormatHandle; bookHandle: BookHandle);
begin
  inherited Create;
  self.book := bookHandle;
  self.handle := formatHandle;
end;
...
constructor TXLConditionalFormat.Create(conditionalFormatHandle: ConditionalFormatHandle; bookHandle: BookHandle);
begin
  inherited Create;
  self.book := bookHandle;
  self.handle := conditionalFormatHandle;
end;
...
constructor TXLSheet.Create(sheetHandle: SheetHandle; bookHandle: BookHandle);
begin
  inherited Create;
  self.book := bookHandle;
  self.handle := sheetHandle;
end;
...
var
  hid: boolean;
begin
  result := xlSheetGetNamedRange(handle, _name, @rowFirst, @rowLast, @colFirst, @colLast, -2, @hid) > 0;
end;
...
begin
  result := xlSheetSetNamedRange(handle, _name, rowFirst, rowLast, colFirst, colLast, -2) > 0;
end;
...
begin
  result := xlSheetDelNamedRange(handle, _name, -2) > 0;
end;
...
begin
  xlSheetSetProtectEx(handle, Integer(_protect), password, -1);
end;
...
function TXLSheet.setBorder(rowFirst: Integer; rowLast: Integer; colFirst: Integer; colLast: Integer; borderStyle: BorderStyle; borderColor: Color): boolean;
begin
  result := xlSheetSetBorder(handle, rowFirst, rowLast, colFirst, colLast, Integer(borderStyle), Integer(borderColor)) > 0;
end;
...
var
  s: PWideChar;
begin
  s := xlBookDefaultFont(handle, addr(_fontSize));
  if s <> nil then
    result := WideString(s)
  else
    result := '';
...
begin
  result := TXLCoreProperties(xlBookCoreProperties(handle));
end;

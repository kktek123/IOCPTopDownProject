...
{   
    abstract public class Book 
    {
        ...
        {
            IntPtr corePropertiesHandle = xlBookCoreProperties(handle);
            if (corePropertiesHandle == IntPtr.Zero)            
                throw new XLError(errorMessage());               
            
            return new CoreProperties(corePropertiesHandle);
        }
        ...
        [DllImport("libxl.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.Cdecl)]
        private static extern IntPtr xlBookCoreProperties(IntPtr handle);
